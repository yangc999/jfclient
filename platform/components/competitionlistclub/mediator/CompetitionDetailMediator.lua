...
function CompetitionDetailMediator:showReward()
    ...
    for i=1,len do 
        ...
        richText:setPosition(100,  self.list:getInnerContainerSize().height-(i-1) * rowSpace - 50)
        richText:formatText()
        ...
        richText2:setPosition(314,  self.list:getInnerContainerSize().height-(i-1) * rowSpace - 50)
