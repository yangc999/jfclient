...
local RequsetQuitCptCommand = class("RequsetQuitCptCommand", SimpleCommand)
local JoinMatchMediator = import("..mediator.JoinMatchMediator")
local GameRoomProxy = import("..proxy.GameRoomProxy") 

function RequsetQuitCptCommand:execute(notification)
	print("RequsetQuitCptCommand")
