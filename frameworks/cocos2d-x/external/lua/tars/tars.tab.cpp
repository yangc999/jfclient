...
/* Line 1455 of yacc.c  */
    {
	assert((yyvsp[(1) - (1)]) == 0 || std::dynamic_pointer_cast<Namespace>((yyvsp[(1) - (1)])));
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	assert((yyvsp[(1) - (1)]) == 0 || std::dynamic_pointer_cast<Interface>((yyvsp[(1) - (1)])));
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	assert((yyvsp[(1) - (1)]) == 0 || std::dynamic_pointer_cast<Struct>((yyvsp[(1) - (1)])));
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	assert((yyvsp[(1) - (1)]) == 0 || std::dynamic_pointer_cast<Enum>((yyvsp[(1) - (1)])));
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	assert((yyvsp[(1) - (1)]) == 0 || std::dynamic_pointer_cast<Const>((yyvsp[(1) - (1)])));
;}
    break;
...
/* Line 1455 of yacc.c  */
	...
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(2) - (2)]));
...
/* Line 1455 of yacc.c  */
	...
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(1) - (1)]));
...
/* Line 1455 of yacc.c  */
    {
	TypePtr type = std::dynamic_pointer_cast<Type>(g_parse->createBuiltin(Builtin::KindLong));
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(1) - (3)]));
    TypeIdPtr tPtr      = std::make_shared<TypeId>(type, ident->v);
	ConstGrammarPtr sPtr = std::dynamic_pointer_cast<ConstGrammar>((yyvsp[(3) - (3)]));
...
/* Line 1455 of yacc.c  */
    {
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(3) - (4)]));
...
/* Line 1455 of yacc.c  */
    {
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(3) - (3)]));
    StructPtr np = g_parse->getKeyStruct();
    if(np)
    {
        np->addKey(ident->v);
...
/* Line 1455 of yacc.c  */
    ...
    {
       g_parse->popContainer();
	   (yyval) = std::dynamic_pointer_cast<GrammarBase>((yyvsp[(2) - (5)]));
    }
    else
    {
       (yyval) = 0;
...
/* Line 1455 of yacc.c  */
    ...
    {
        g_parse->popContainer();
		(yyval) = std::dynamic_pointer_cast<GrammarBase>((yyvsp[(1) - (3)]));
    }
    else
    {
        (yyval) = 0;
...
/* Line 1455 of yacc.c  */
    {
	TypePtr returnType = std::dynamic_pointer_cast<Type>((yyvsp[(1) - (2)]));
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(2) - (2)]));
    string name        = ident->v;
...
/* Line 1455 of yacc.c  */
    {
	TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(1) - (1)]));
...
/* Line 1455 of yacc.c  */
    {
	TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(3) - (3)]));
...
/* Line 1455 of yacc.c  */
    {
			 BoolGrammarPtr isOutParam = std::dynamic_pointer_cast<BoolGrammar>((yyvsp[(1) - (2)]));
			 TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(2) - (2)]));
...
/* Line 1455 of yacc.c  */
    {
	BoolGrammarPtr isOutParam = std::dynamic_pointer_cast<BoolGrammar>((yyvsp[(3) - (4)]));
	TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(4) - (4)]));
...
/* Line 1455 of yacc.c  */
    {
	BoolGrammarPtr isRouteKeyParam = std::dynamic_pointer_cast<BoolGrammar>((yyvsp[(1) - (2)]));
	TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(2) - (2)]));
...
/* Line 1455 of yacc.c  */
    {
	BoolGrammarPtr isRouteKeyParam = std::dynamic_pointer_cast<BoolGrammar>((yyvsp[(3) - (4)]));
	TypeIdPtr  tsp = std::dynamic_pointer_cast<TypeId>((yyvsp[(4) - (4)]));
...
/* Line 1455 of yacc.c  */
    {
	(yyval) = std::dynamic_pointer_cast<GrammarBase>((yyvsp[(1) - (1)]));
;}
    break;
...
/* Line 1455 of yacc.c  */
    ...
    if(np)
    {
		IntergerGrammarPtr iPtr = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(1) - (3)]));
        g_parse->checkTag(iPtr->v);

		TypeIdPtr tPtr = std::dynamic_pointer_cast<TypeId>((yyvsp[(3) - (3)]));
        tPtr->setRequire(iPtr->v);
        np->addTypeId(tPtr);
		(yyval) = std::dynamic_pointer_cast<GrammarBase>((yyvsp[(3) - (3)]));
    }
    else
    {
        (yyval) = 0;
...
/* Line 1455 of yacc.c  */
    ...
    if(np)
    {
		IntergerGrammarPtr iPtr = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(1) - (5)]));
        g_parse->checkTag(iPtr->v);

        //判断类型和数值类型是否一致
		TypeIdPtr tPtr = std::dynamic_pointer_cast<TypeId>((yyvsp[(3) - (5)]));
		ConstGrammarPtr sPtr = std::dynamic_pointer_cast<ConstGrammar>((yyvsp[(5) - (5)]));
        g_parse->checkConstValue(tPtr, sPtr->t);

        tPtr->setRequire(iPtr->v);
        tPtr->setDefault(sPtr->v);
        np->addTypeId(tPtr);
		(yyval) = std::dynamic_pointer_cast<GrammarBase>((yyvsp[(3) - (5)]));
    }
    else
    {
        (yyval) = 0;
...
/* Line 1455 of yacc.c  */
    {
	IntergerGrammarPtr intVal = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(1) - (1)]));
    ostringstream sstr;
    sstr << intVal->v;
...
/* Line 1455 of yacc.c  */
    {
	FloatGrammarPtr floatVal = std::dynamic_pointer_cast<FloatGrammar>((yyvsp[(1) - (1)]));
    ostringstream sstr;
    sstr << floatVal->v;
	ConstGrammarPtr c = std::make_shared<ConstGrammar>();
    c->t = ConstGrammar::VALUE;
...
/* Line 1455 of yacc.c  */
	...
	StringGrammarPtr scoped = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(1) - (3)]));
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(3) - (3)]));
...
/* Line 1455 of yacc.c  */
	...
	TypeIdPtr t = std::dynamic_pointer_cast<TypeId>((yyvsp[(2) - (4)]));
	ConstGrammarPtr c = std::dynamic_pointer_cast<ConstGrammar>((yyvsp[(4) - (4)]));
...
/* Line 1455 of yacc.c  */
    {
	TypePtr type = std::dynamic_pointer_cast<Type>((yyvsp[(1) - (2)]));
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(2) - (2)]));
...
/* Line 1455 of yacc.c  */
    {
	TypePtr type = g_parse->createVector(std::dynamic_pointer_cast<Type>((yyvsp[(1) - (5)])));
	IntergerGrammarPtr iPtrSize = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(4) - (5)]));
    g_parse->checkArrayVaid(type,iPtrSize->v);
    type->setArray(iPtrSize->v);
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(2) - (5)]));
	TypeIdPtr typeIdPtr = std::make_shared<TypeId>(type, ident->v);
	(yyval) = std::dynamic_pointer_cast<GrammarBase>(typeIdPtr);
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	TypePtr type = g_parse->createVector(std::dynamic_pointer_cast<Type>((yyvsp[(1) - (3)])));
    //IntergerGrammarPtr iPtrSize = IntergerGrammar>($4);
...
/* Line 1455 of yacc.c  */
    {
	TypePtr type = std::dynamic_pointer_cast<Type>((yyvsp[(1) - (4)]));
	StringGrammarPtr ident = std::dynamic_pointer_cast<StringGrammar>((yyvsp[(2) - (4)]));
	TypeIdPtr typeIdPtr = std::make_shared<TypeId>(type, ident->v);
	IntergerGrammarPtr iPtrSize = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(3) - (4)]));
    g_parse->checkArrayVaid(type,iPtrSize->v);
	(yyval) = std::dynamic_pointer_cast<GrammarBase>(typeIdPtr);
;}
    break;
...
/* Line 1455 of yacc.c  */
	...
	TypePtr type = std::dynamic_pointer_cast<Type>((yyvsp[(1) - (3)]));
	IntergerGrammarPtr iPtrSize = std::dynamic_pointer_cast<IntergerGrammar>((yyvsp[(3) - (3)]));
    g_parse->checkArrayVaid(type,iPtrSize->v);
    type->setArray(iPtrSize->v);
    (yyval) = type;
;}
...
/* Line 1455 of yacc.c  */
    {
	(yyval) = std::dynamic_pointer_cast<GrammarBase>(g_parse->createVector(std::dynamic_pointer_cast<Type>((yyvsp[(3) - (4)]))));
;}
    break;
...
/* Line 1455 of yacc.c  */
    {
	(yyval) = std::dynamic_pointer_cast<GrammarBase>(g_parse->createMap(std::dynamic_pointer_cast<Type>((yyvsp[(3) - (6)])), std::dynamic_pointer_cast<Type>((yyvsp[(5) - (6)]))));
;}
    break;
