...
int lua_cocos2dx_extension_AssetsManager_setVersion(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::AssetsManager* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_AssetsManager_setVersion'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "cc.AssetsManager:setVersion"); arg0 = arg0_tmp.c_str();
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_AssetsManager_setVersion'", nullptr);
			return 0;
		}
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.AssetsManager:setVersion", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
	tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_AssetsManager_setVersion'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_AssetsManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"AssetsManager");
		...
		tolua_function(tolua_S, "setVersion", lua_cocos2dx_extension_AssetsManager_setVersion);
